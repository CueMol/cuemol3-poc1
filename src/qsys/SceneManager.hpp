...
public:
    ...
    const LString &getVersion() const
    {
        return m_strVerInfo;
    }
    ...
    {
        return m_verInfo.major_version;
    }
    int getMinorVer() const
    {
        return m_verInfo.minor_version;
    }
    int getRevision() const
    {
        return m_verInfo.revision;
    }
    int getBuildNo() const
    {
        return m_verInfo.build_no;
    }

    /// Get ID of this release
    const LString &getBuildID() const
    {
        return m_verInfo.build_id;
    }
...
public:
    ...
    LString convPath(const LString &path);
};
